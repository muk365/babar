document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================
    // SECTION 1: FONCTIONS DE DÉMARRAGE ET D'AUTHENTIFICATION
    // ==========================================================
    ...
    // ==========================================================
    // SECTION 2: GESTION DU BOT DE CHAT
    // ==========================================================

    function connectToTwitchChat() {
        if (!session.userInfo || !session.token) {
            alert("Erreur: Impossible de se connecter, informations utilisateur manquantes. Essayez de vous reconnecter.");
            return;
        }
        ...
        // 1. Définir ce qu'il se passe lors de chaque événement
        ...
        // 2. Lancer la connexion après que TOUT a été défini
